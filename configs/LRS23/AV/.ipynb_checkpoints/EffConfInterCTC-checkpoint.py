...
training_audio_transform=nn.Sequential(
    nnet.transforms.BabbleNoise(noise_file_path="datasets/babble.wav", SNR_db=[-7.5, -5, 0, 5, 10, 15, None], to_sample_rate=16000),
)
...
training_dataset = nnet.datasets.MultiDataset(
    ...
    nnet.datasets.LRS(
        ...
        audio_transform=training_audio_transform,
        align=align
    ),
    # nnet.datasets.LRS(
    #     batch_size=None,
