...
lrs2_dataset = nnet.datasets.LRS(None, None, version="LRS2", download=False, prepare=True, tokenizer_path=tokenizer_path, mean_face_path=mean_face_path, workers_prepare=workers_prepare, mode="pretrain+train+val")
...
filenames = [
    "datasets/LRS2/corpus_pretrain.txt", 
    "datasets/LRS2/corpus_train.txt", 
    "datasets/LRS2/corpus_val.txt",
    # "datasets/LRS3/corpus_pretrain.txt",
    # "datasets/LRS3/corpus_trainval.txt"
]
with open("datasets/LRS2/corpus_lrs23_pretrain+train+val.txt", "w") as fw:
